...
import { VNode, CSSProperties, Component, PropType, Ref, InjectionKey } from 'vue';
...
interface GridInstance<TData = unknown> {
    ...
    readonly plugins: {
        dataSource: PublicOf<DataSourcePlugin<TData>>;
        rowModel: PublicOf<RowModelPlugin>;
        columnModel: PublicOf<ColumnModelPlugin>;
        filter: PublicOf<FilterPlugin>;
        sort: PublicOf<SortPlugin>;
        pagination: PublicOf<PaginationPlugin>;
        viewport: PublicOf<ViewportPlugin>;
        selection: PublicOf<SelectionPlugin>;
        edit: PublicOf<EditPlugin>;
        cellValue: PublicOf<CellValuePlugin>;
        focus: PublicOf<FocusPlugin>;
        announcement: PublicOf<AnnouncementPlugin>;
        export: PublicOf<ExportPlugin>;
    };
...
declare function useCreateGrid<TData = unknown>(options: GridOptions<TData>): GridInstance<TData>;

declare const Grid: vue.DefineComponent<vue.ExtractPropTypes<{
    grid: {
        type: PropType<GridInstance<unknown>>;
        required: true;
    };
...
declare const GridHeader: vue.DefineComponent<{}, () => (vue.VNode<vue.RendererNode, vue.RendererElement, {
    [key: string]: any;
...
declare const GridBody: vue.DefineComponent<{}, () => vue.VNode<vue.RendererNode, vue.RendererElement, {
    [key: string]: any;
}>, {}, {}, {}, vue.ComponentOptionsMixin, vue.ComponentOptionsMixin, {}, string, vue.PublicProps, Readonly<{}> & Readonly<{}>, {}, {}, {}, {}, string, vue.ComponentProvideOptions, true, {}, any>;

declare const GridRow: vue.DefineComponent<vue.ExtractPropTypes<{
    rowId: {
    ...
    visibleColumnIds: {
        type: PropType<ColumnId[]>;
        required: true;
    };
    columnWidths: {
        type: PropType<Map<string, number>>;
        required: true;
    };
    columnDefMap: {
        type: PropType<Map<string, unknown>>;
        required: true;
    };
    columnOptionsMap: {
        type: PropType<Map<string, ColumnDef>>;
        required: true;
    };
}>, () => vue.VNode<vue.RendererNode, vue.RendererElement, {
    [key: string]: any;
...
declare const GridCell: vue.DefineComponent<vue.ExtractPropTypes<{
    rowId: {
        type: StringConstructor;
        required: true;
    };
...
declare const GridCellEditor: vue.DefineComponent<vue.ExtractPropTypes<{
    cell: {
    ...
    editorConfig: {
        type: PropType<ColumnEditorConfig | null>;
        default: null;
    };
    colWidth: {
        type: NumberConstructor;
    ...
    isValid: boolean;
    validationError: string | null;
    editorConfig: ColumnEditorConfig | null;
    rowHeight: number;
}, {}, {}, {}, string, vue.ComponentProvideOptions, true, {}, any>;

declare const GridPagination: vue.DefineComponent<{}, () => vue.VNode<vue.RendererNode, vue.RendererElement, {
    [key: string]: any;
}> | null, {}, {}, {}, vue.ComponentOptionsMixin, vue.ComponentOptionsMixin, {}, string, vue.PublicProps, Readonly<{}> & Readonly<{}>, {}, {}, {}, {}, string, vue.ComponentProvideOptions, true, {}, any>;

declare const GridOverlay: vue.DefineComponent<{}, () => vue.VNode<vue.RendererNode, vue.RendererElement, {
    [key: string]: any;
}> | null, {}, {}, {}, vue.ComponentOptionsMixin, vue.ComponentOptionsMixin, {}, string, vue.PublicProps, Readonly<{}> & Readonly<{}>, {}, {}, {}, {}, string, vue.ComponentProvideOptions, true, {}, any>;

type FilterType = 'text' | 'number' | 'date' | 'boolean';
declare const GridFilterPopover: vue.DefineComponent<vue.ExtractPropTypes<{
    columnId: {
        type: StringConstructor;
        required: true;
    };
    filterType: {
        type: PropType<FilterType>;
        required: true;
    };
    anchorRef: {
...
declare function useViewportState(grid: GridInstance): Readonly<Ref<ViewportNamespace>>;
declare function useColumnsState(grid: GridInstance): Readonly<Ref<ColumnsNamespace>>;
declare function usePaginationState(grid: GridInstance): Readonly<Ref<PaginatedNamespace>>;
declare function useSortedState(grid: GridInstance): Readonly<Ref<SortedNamespace>>;
declare function useFilteredState(grid: GridInstance): Readonly<Ref<FilteredNamespace>>;
declare function useRawState(grid: GridInstance): Readonly<Ref<RawNamespace>>;
declare function useSelectionState(grid: GridInstance): Readonly<Ref<SelectionNamespace>>;
declare function useEditState(grid: GridInstance): Readonly<Ref<EditingNamespace>>;
declare function useFocusState(grid: GridInstance): Readonly<Ref<FocusNamespace>>;
declare function useCellSelected(grid: GridInstance, rowId: string): Readonly<Ref<boolean>>;
declare function useCellFocused(grid: GridInstance, rowId: string, columnId: string): Readonly<Ref<boolean>>;
declare function useCellEditing(grid: GridInstance, rowId: string, columnId: string): Readonly<Ref<boolean>>;

interface UseGridReturn {
    containerRef: Ref<HTMLDivElement | null>;
}
declare function useGrid(grid: GridInstance): UseGridReturn;

declare function useFocusManager(grid: GridInstance, containerRef: Ref<HTMLDivElement | null>): void;

interface ExportTriggerOptions {
    scope?: 'all' | 'filtered' | 'page' | 'selected';
    filename?: string;
}
declare function useExport(grid: GridInstance): {
    triggerExport: (overrides?: ExportTriggerOptions) => void;
};

declare function useStoreNamespace<K extends NamespaceKey>(grid: GridInstance, namespace: K): Readonly<Ref<StoreState[K]>>;

declare const GridInstanceKey: InjectionKey<GridInstance<unknown>>;
declare function useGridContext<TData = unknown>(): GridInstance<TData>;

declare function calculateColumnWidths(definitions: ColumnDefinition[], columnOptions: ColumnDef[], containerWidth: number): Map<string, number>;

export { type AnnouncementMessages, type ColumnDef, type ColumnState, Grid, type GridAPI, GridBody, GridCell, GridCellEditor, GridEvent, GridFilterPopover, GridHeader, type GridInstance, GridInstanceKey, type GridOptions, GridOverlay, GridPagination, GridRow, type PaginationState, calculateColumnWidths, createGrid, useCellEditing, useCellFocused, useCellSelected, useColumnsState, useCreateGrid, useEditState, useExport, useFilteredState, useFocusManager, useFocusState, useGrid, useGridContext, usePaginationState, useRawState, useSelectionState, useSortedState, useStoreNamespace, useViewportState };
