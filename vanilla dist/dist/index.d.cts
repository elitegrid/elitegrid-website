...
type VanillaNode = HTMLElement | string | null | undefined;
type VanillaRenderer<TArgs extends unknown[] = []> = (container: HTMLElement, ...args: TArgs) => void;
interface GridOptions<TData = unknown> {
    ...
    filtering?: {
        ...
        filterIcon?: VanillaNode;
        activeFilterIcon?: VanillaNode;
    ...
    appearance?: {
        ...
        emptyStateComponent?: VanillaRenderer;
        loadingState?: {
            message?: string;
        };
        loadingComponent?: VanillaRenderer;
        errorComponent?: VanillaRenderer<[Error]>;
    };
    scroll?: {
        bufferSize?: number;
    };
...
declare function buildGridAPI<TData>(grid: GridInstance<TData>): GridAPI<TData>;

interface MountOptions {
    destroyOnDispose?: boolean;
}
declare function mount<TData = unknown>(grid: GridInstance<TData>, container: HTMLElement, opts?: MountOptions): () => void;

export { type AnnouncementMessages, type ColumnDef, type ColumnState, type GridAPI, GridEvent, type GridInstance, type GridOptions, type MountOptions, type PaginationState, type SortDirection, type VanillaNode, type VanillaRenderer, buildGridAPI, createGrid, mount };
