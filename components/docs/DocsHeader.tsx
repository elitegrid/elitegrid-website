    ...
    <nav className="fixed top-0 left-0 right-0 z-[200] h-[60px] bg-[rgba(245,244,239,0.9)] dark:bg-[rgba(9,9,14,0.9)] border-b border-black/[0.08] dark:border-white/[0.07] backdrop-blur-xl flex items-center px-4 min-[900px]:px-7 gap-0">
      ...
      <div ref={boxRef} className="relative flex-1 max-w-[320px] hidden min-[640px]:block">
        ...
        <input
          ...
          className="w-full bg-black/[0.025] dark:bg-white/[0.025] border border-black/[0.08] dark:border-white/[0.07] rounded-lg pl-8 pr-9 py-2.5 text-[16px] font-body text-[#18181b] dark:text-[#edf0fa] placeholder:text-[#a3a3a3] dark:placeholder:text-[#374151] outline-none focus:border-[rgba(91,33,182,0.45)] transition-colors"
        />
      ...
      <div className="hidden min-[900px]:flex items-center gap-7 ml-auto mr-7">
        <Link href="/playground" className="text-[16px] font-medium text-[#525252] dark:text-[#7a8399] hover:text-[#18181b] dark:hover:text-[#edf0fa] transition-colors">
          Playground
        </Link>
        <Link href="/" className="text-[16px] font-medium text-[#525252] dark:text-[#7a8399] hover:text-[#18181b] dark:hover:text-[#edf0fa] transition-colors">
          Site
        </Link>
        <a
          ...
          className="text-[16px] font-medium text-[#525252] dark:text-[#7a8399] hover:text-[#18181b] dark:hover:text-[#edf0fa] transition-colors inline-flex items-center gap-1.5"
        >
